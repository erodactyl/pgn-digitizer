...
const akopianGames_json_1 = __importDefault(require("../testData.json"));
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (let left of batchStarts) {
      ...
      yield Promise.all(
        currBatch.map((key) =>
          __awaiter(void 0, void 0, void 0, function* () {
            const game = yield getScannedGame_1.default(key);
            pgns[key] = game;
          })
        )
      );
      console.log(`Games for batch ${left}-${left + batchSize} done`);
    }
    const json = JSON.stringify(pgns);
    fs_1.default.writeFile("scans.json", json, () => {});
  });
main();
